...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("تنصيب Source Miro ❤️", "https://t.me/SourceMiro"),
                Button.url(
                    "مساعدة ❓",
                    "https://t.me/w_3_2",
                ),
        ...
        buttons = [
            [
                Button.url("• السورس •", "https://t.me/SourceMiro"),
            ],
            [
