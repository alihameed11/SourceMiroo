...
async def we(event):
    await edit_or_reply(
        event,
        "**[ . Source Miro ♛  .](t.me/SourceMiro)**\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n• اوامـر الـــتـحـكـم تتيح لمستخدم اخر ان يستخدم اوامـر تنصيبك وهو غير منصب ميرو حيث سيصبح متحكم في اوامـر تنصيبك يرجى الانتباه من انه سيحصل على صلاحيات الاوامـر وقد يسبب خطورة لك اذا كنت لا تثق في المستخدم الذي اضفته. \n\n\n`.الـــتـحـكـم` تفعيل/تعطيل\n• تستخدم هذه الميزة لتفعيل/لتعطيل خاصية الـــتـحـكـم بأوامر تنصيبك للمستخدمين الذين أضفتهم في قائمة المتحكمين\n\n`.المتحكمين`\n• لعرض المستخدمين الذين اضفتهم الى قائمة المستخدمين المتحكمين\n\n`.اضف متحكم`\n• بالرد على المستخدم لأضافته متحكم في تنصيب ميرو الخاص بك\n\n`.ازالة متحكم`\n• بالرد على المستخدم لازالته من قائمة المتحكمين",
        link_preview=False,
    )
